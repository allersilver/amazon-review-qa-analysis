...
AI 학습 데이터 품질 관리 관점에서 분석한 프로젝트입니다.
오류 유형을 분류하고 납품 가능한 데이터 비율을 측정했습니다.
...
| 04 | funnel_retention | 퍼널 및 코호트 리텐션 분석 |
| 05 | review_quality | 리뷰 텍스트 품질 분류 |
| 06 | sql_analysis | SQL 기반 데이터 품질 분석 |
| 07 | insight_action | 핵심 인사이트 및 서비스 액션 |
